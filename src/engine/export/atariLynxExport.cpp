...
std::vector<DivROMExportOutput> DivExportAtariLynx::go(DivEngine* e) {
...
void DivExportAtariLynx::writeTrackV0(
  DivEngine* e,
...
void DivExportAtariLynx::writeTrackV1(
  DivEngine* e, 
  std::map<uint64_t, String> &commonDumpSequences,
  std::map<uint64_t, unsigned int> &frequencyMap,
  std::map<String, String> &representativeMap,
...
void DivExportAtariLynx::writeTrackV2(
  DivEngine* e, 
  std::map<uint64_t, String> &commonDumpSequences,
  std::map<String, String> &representativeMap,
  std::vector<String> *channelSequences,
 ...
 *   00000000                    stop
 */
size_t DivExportAtariLynx::writeNote(SafeWriter* w, const ChannelState& next, const char duration, const ChannelState& last) {
...
void DivExportAtariLynx::writeNoteBinary(SafeWriter* w, const ChannelState& next, const char duration, const ChannelState& last) {
  unsigned char dmod = 0; // if duration is small, store in top bits of frequency
...
void DivExportAtariLynx::writeWaveformHeader(SafeWriter* w, const char * key) {
...
size_t DivExportAtariLynx::writeTextGraphics(SafeWriter* w, const char* value) {
  size_t bytesWritten = 0;
